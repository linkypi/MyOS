...
OBJS		= kernel/kernel.o kernel/start.o kernel/i8259.o kernel/global.o kernel/protect.o \
				lib/klib.o lib/kliba.o lib/string.o kernel/main.o

DASMOUTPUT	= kernel.bin.asm

# All Phony Targets
.PHONY : everything final run clean realclean disasm all buildimg

# Default starting position
everything : $(ORANGESBOOT) $(KERNEL)
...
kernel/start.o: kernel/start.c include/type.h include/const.h include/protect.h \
			include/proto.h include/string.h include/global.h include/process.h
	$(CC) $(CFLAGS) -o $@ $<
...
kernel/global.o : kernel/global.c include/type.h include/const.h include/protect.h \
		          include/proto.h include/process.h include/global.h 
	$(CC) $(CFLAGS) -o $@ $<

kernel/protect.o : kernel/protect.c include/type.h include/const.h include/protect.h \
		          include/proto.h include/process.h include/global.h include/string.h
	$(CC) $(CFLAGS) -o $@ $<
